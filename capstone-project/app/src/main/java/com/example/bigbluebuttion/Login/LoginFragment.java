...
import com.example.bigbluebuttion.forget_passwrod;
import com.example.bigbluebutton.R;

import com.example.bigbluebuttion.home;
...
public class LoginFragment extends AppCompatActivity {
    ...
    /*
        ...
        public void onStart() {
            ...
            if(currentUser == null){
                Intent signup = new Intent(getApplicationContext(), afterlogin.class);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(task.isSuccessful()){
                                        Intent login = new Intent(LoginFragment.this,home.class);
                                        startActivity(login);
