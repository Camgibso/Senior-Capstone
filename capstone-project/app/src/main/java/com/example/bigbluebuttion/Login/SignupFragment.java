...
public class SignupFragment extends AppCompatActivity {
    TextInputEditText email, password, first,middle, last, textInputEditText, textInputEditText2 ;
    EditText  mobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        middle =findViewById(R.id.reg_mid);
                            ...
                            if(task.isSuccessful()){
                                ...
                                mAuth.signInWithEmailAndPassword(email.getText().toString(), password.getText().toString())
                                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                if(task.isSuccessful()){
                                                    Intent login = new Intent(SignupFragment.this, LoginFragment.class);
                                                    startActivity(login);
